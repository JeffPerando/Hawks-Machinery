...
public class HawkManager
{
	...
	public static void loadRecipes()
	{
		...
		RECIPE_GIVER.addRecipe(new ItemStack(BasicComponents.ItemSteelIngot, 24), new Object[]{"e", 'e', BASEMOD.blockEmptyMachine});
		...
		RECIPE_GIVER.addShapelessRecipe(new ItemStack(BasicComponents.ItemSteelClump, 1), new Object[]{Item.ingotIron, new ItemStack(BASEMOD.dust, 1, 0)});
		...
		RECIPE_GIVER.addShapelessRecipe(new ItemStack(Item.pumpkinSeeds, 4), new Object[]{Block.pumpkinLantern});
		RECIPE_GIVER.addShapelessRecipe(new ItemStack(Item.fireballCharge, 3), new Object[]{Item.gunpowder, Item.blazePowder, new ItemStack(BASEMOD.dust, 1, 0)});
