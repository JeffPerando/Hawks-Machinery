...
public class HawkAchievements
{
	...
	public static Achievement timeToGrind = new Achievement(HawkManager.ACHtimeToGrind, "Time to Grind", 4, -6, new ItemStack(BASEMOD.blockGrinder, 1, 0), redstonedWithCare).registerAchievement().setSpecial();
