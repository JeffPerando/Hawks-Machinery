...
{
    public final int WATER_LIMIT = 9;
    ...
    public void updateEntity()
    {
        ...
        {
            // TODO might want to change this to check if no pipe mod is
            // installed, or use config option
        ...
        if (!this.isDisabled() && !worldObj.isRemote)
        {
            //water level update
    ...
    public boolean canWork()
    {
        ...
        return output != null
                && (this.electricityStored >= (this.ELECTRICITY_REQUIRED * 2)
                && this.waterUnits >= 1.0)
                && (this.containingItems[3] == null || (output.isItemEqual(this.containingItems[3])
                && output.stackSize + this.containingItems[3].stackSize <= output.getMaxStackSize()));
    }
    ...
    public void writeToNBT(NBTTagCompound NBTTag)
    {
        ...
        int water = 0;
        if (this.waterTank.getLiquid() != null) water = this.waterTank.getLiquid().amount;
        NBTTag.setInteger("waterUnits", water);
