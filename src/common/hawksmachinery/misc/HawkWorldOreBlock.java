 ...
 * @author Elusivehawk
 */
public class HawkWorldOreBlock extends WorldGenerator
{
    ...
    public HawkWorldOreBlock(int id, int meta, int number)
    {
                    ...
                    for (int var41 = var33; var41 <= var36; ++var41)
                    {
                        ...
                        if (var39 * var39 + var42 * var42 < 1.0D)
                        {
                            for (int var44 = var34; var44 <= var37; ++var44)
                            {
                                ...
                                if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && block != null && (block == Block.netherrack || block == Block.whiteStone))
                                {
                                    world.setBlockAndMetadata(var38, var41, var44, this.minableBlockId, minableBlockMeta);
                                }
                            }
                        }
                    }
