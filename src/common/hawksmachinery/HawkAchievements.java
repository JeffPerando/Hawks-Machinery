...
public class HawkAchievements
{
	...
	public static Achievement prospector = new Achievement(BASEMOD.ACHprospector, "Prospectpr", -1, 0, new ItemStack(BASEMOD.blockOre, 1, 0), AchievementList.buildBetterPickaxe).registerAchievement();
